...
public class reproductor_video_seleccion extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button btnSeleccionTexto;
    //Solo para landscape
    private Button btnSeleccionFlotante;

    //para control del fondo
    private ImageView imageViewFondo;
    private FrameLayout frameLayoutImagenFondo;
    private ImageView imageViewFondoLand;
    private FrameLayout frameLayoutImagenFondoLand;
    Funcionalidad funcVideo;
    private Uri uri = null;

    //Variable que controla X del botón
    private int btnSeleccionTextoX;
    ...
    /**
     * Método para saber los grados en los que está grabado el vídeo uso de MediaMetadataRetriver
     *
     * @param path
     * @return
     */
